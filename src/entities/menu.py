...
class Menu:
    def __init__(
        ...
        self.id_menu: uuid.UUID = uuid.uuid4()
        self.nombre = nombre.strip()
        self.ids_platos = ids_platos  # relación con Plato: lista de platos que contiene este menú
    ...
    def __str__(self) -> str:
        return f"Menu({self.id_menu}) - {self.nombre}: {len(self.ids_platos)} platos"