...
menu_plato = Table(
    "menu_plato",
    Base.metadata,
    Column("id_menu", PGUUID(as_uuid=True), ForeignKey("menus.id_menu"), primary_key=True),
...
class Menu(Base):
    ...
    id_menu: Mapped[uuid.UUID] = mapped_column(PGUUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    nombre: Mapped[str] = mapped_column(String(150), nullable=False)
    descripcion: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, default="")
